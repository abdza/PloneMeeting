...
##parameters=workflow_action=None, comment='', effective_date=None, expiration_date=None, came_from=None, *args
...
msg = _('%s_done_descr' % workflow_action, default=u'Your content\'s status has been modified.')
context.plone_utils.addPortalMessage(msg)

# The 2 following lines are added by PloneMeeting : we want to manage a
# 'came_from' attribute that redirects the user to the page he cames from

if context.REQUEST.has_key('came_from'):
    return state.set(status='success_with_came_from')
